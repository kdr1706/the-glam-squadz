<?php
/*
   Plugin Name: Sharkdropship Affiliate & dropshipping for AliExpress
...
function wads_our_plugin_action_links($links, $file)
{
    ...
    if ($file == $this_plugin) {
        ...
        $settings_link = '<a style="color:red" target="_blank" href="https://sharkdropship.com/aliexpress">Go pro</a>';
