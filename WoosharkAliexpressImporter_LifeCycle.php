...
class WoosharkAliexpressImporter_LifeCycle extends WoosharkAliexpressImporter_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToPluginsMenu()
    {
        ...
        add_menu_page(
            ...
            plugin_dir_url(__FILE__) . 'images/wooshark_1_27x27.png'
        );
...
<?php
    ...
    public function submenuAliExpressCallback()
    {
        ...
        <p style="olor: #513434; padding: 61px; font-size: 2rem; background-color: #eee9e9; border-radius: 10px; margin: 20px; font-size: 20px;">Unlock the full potential of your WordPress store by installing our Chrome extension! Seamlessly import products directly from supplier pages with just a few clicks. It is incredibly easy to install and saves you valuable time, allowing you to focus on growing your business. !
        </p>
        <p style="color: #513434; padding: 61px; font-size: 2rem; background-color: #eee9e9; border-radius: 10px; margin: 20px; }"> please install the chrome extension from here <a target=”_blank” href="https://chromewebstore.google.com/detail/sharkd-for-temualiexpress/ajbncoijgeclkangiahiphilnolbdmmh">  Here is the link to the extension</a></p> ';
