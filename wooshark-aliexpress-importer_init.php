...
function theSharkAliExpress_getProductsCount_FROM_WP()
{
...
function theSharkAliExpress_get_categories_FROMWP()
{
...
function checkDailyImport_alibay()
{
  ...
  if ($currentImportCount >= 30) {
    $results = array('error' => true, 'error_msg' => 'Daily import limit of 30 products reached. Please try again tomorrow or upgrade to premium plan', 'data' => '');
    wp_send_json($results);
    return;
  }
...
function theSharkAliExpress_insertProductInWoocommerceAffiliate()
{
  ...
  try {
    if (isset($_POST)) {
      ...
      // Save product images
      // $imageUploadErrors = theSharkAliExpress_save_product_images_for_ebay_alibay($product, $images);

      $response = theSharkAliExpress_save_product_images_for_ebay_alibay($product, $images);
      ...
      $category_ids = theSharkAliExpress_create_woocommerce_categories_and_get_ids_alibay($remoteCategories);
...
function theSharkAliExpress_insertProductInWoocommerce()
{
              ...
              if (($importVariationImages == 'true')) {
                ...
                if (isset($imageVariations)) {
                  ...
                  if ($imageId != false) {
                    ...
                    $imageIdVariation  =  theSharkAliExpress_save_single_variation_image_alibay($variationToCreate, $imageVariations);
...
function theSharkAliExpress_getProductsDraft()
{
...
function theSharkAliExpress_getOldProductDetails()
{
...
function theSharkAliExpress_removeProductFromShop()
{
...
function theSharkAliExpress_insertReviewsIntoProduct()
{
  // Check if the user is authenticated and has the necessary permissions
      if (!current_user_can('manage_options')) {
...
function theSharkAliExpress_getAlreadyImportedProducts()
{
...
function theSharkAliExpress_getSKuAbdUrlByCategory_alibay()
{
...
function theSharkAliExpress_searchCategoryByName()
{
  // Check if the user is authenticated and has the necessary permissions
      if (!current_user_can('manage_options')) {
...
function theSharkAliExpress_save_product_images_alibay($product, $images)
{
  if (is_array($images)) {
...
function theSharkAliExpress_save_single_variation_image_alibay($product, $image)
{
  $gallery = array();
  if (isset($image)) {
    $upload = wc_rest_upload_image_from_url(esc_url_raw($image));
...
function theSharkAliExpress_searchProductByIdReviews_alibay()
{
...
function theSharkAliExpress_saveOptionsDB_alibay()
{
...
function theSharkAliExpress_insertReviewsIntoProductRM_PREMUIM_PLUGIN_alibay()
{
...
function theSharkAliExpress_restoreConfiguration_alibay()
{
  // Check if the user is authenticated and has the necessary permissions
      if (!current_user_can('manage_options')) {
...
function theSharkAliExpress_getProductsCount_FROM_WP_for_ebay_alibay()
{
...
function theSharkAliExpress_insertVariations()
{
...
function theSharkAliExpress_setProductToDraft_for_ebay_alibay()
{
...
function theSharkAliExpress_updateProductSimple_for_ebay_alibay()
{
...
function theSharkAliExpress_updateProductVariations_for_ebay_alibay()
{
...
function theSharkAliExpress_getOldProductDetails_for_ebay_alibay()
{
...
function theSharkAliExpress_searchProductBySku_for_ebay_alibay()
{
...
function theSharkAliExpress_removeProductFromShop_for_ebay_alibay()
{
...
function theSharkAliExpress_insertReviewsIntoProduct_for_ebay_alibay()
{
...
function theSharkAliExpress_getAlreadyImportedProducts_for_ebay_alibay()
{
...
function theSharkAliExpress_getSKuAbdUrlByCategory_for_ebay_alibay()
{
...
function theSharkAliExpress_save_product_images_for_ebay_alibay($product, $images)
{
...
function theSharkAliExpress_insertReviewsIntoProductRM_for_ebay()
{
...
function theSharkAliExpress_stopAutomaticUpdates_alibay()
{
...
function theSharkAliExpress_removeProductFromShop_forEBAY_alibay()
{
...
function theSharkAliExpress_get_aliexpress_products_alibay()
{
  ...
  $selected_suppliers = isset($_POST['suppliers']) ? $_POST['suppliers'] : array('aliexpress');
...
function theSharkAliExpress_searchProductBySku()
{
...
function theSharkAliExpress_get_products_by_type_alibay()
{
...
function theSharkAliExpress_get_product_details_alibay()
{
...
function theSharkAliExpress_update_variations_on_woocommerce_alibay()
{
...
function theSharkAliExpress_set_product_to_draft_callback_alibay()
{
...
function theSharkAliExpress_fetchemote_alibay()
{
...
function theSharkAliExpress_load_woocommerce_variations_alibay()
{
...
function theSharkAliExpress_delete_product_callback_alibay()
{
...
function theSharkAliExpress_search_product_by_store_alibay($ebay_url)
{
...
function theSharkAliExpress_updateProductUrlAlibay()
{
...
function theSharkAliExpress_create_woocommerce_categories_and_get_ids_alibay($categories)
{
  $category_ids = array();
...
function theSharkAliExpressmy_plugin_webp_is_displayable_alibay($result, $path)
{
  if ($result === false) {
...
add_filter('file_is_displayable_image', 'theSharkAliExpressmy_plugin_webp_is_displayable_alibay', 10, 2);




add_action('wp_ajax_sharkDropship-theShark-alibay-insertVariations', 'theSharkAliExpress_insertVariations');
add_action('wp_ajax_sharkDropship-theShark_alibay_insertProductInWoocommerceAffiliate', 'theSharkAliExpress_insertProductInWoocommerceAffiliate');
add_action('wp_ajax_sharkDropship-alibay-get-sku-and-url-by-Category_for_ebay', 'theSharkAliExpress_getSKuAbdUrlByCategory_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-get-already-imported-products_for_ebay', 'theSharkAliExpress_getAlreadyImportedProducts_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-insert-reviews-to-product_for_ebay', 'theSharkAliExpress_insertReviewsIntoProduct_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-remove-product-from-wp_for_ebay', 'theSharkAliExpress_removeProductFromShop_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-search-product-by-sku_for_ebay', 'theSharkAliExpress_searchProductBySku_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-update-product-variations_for_ebay', 'theSharkAliExpress_updateProductVariations_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-update-product-simple_for_ebay', 'theSharkAliExpress_updateProductSimple_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-get-old-product-details_for_ebay', 'theSharkAliExpress_getOldProductDetails_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-alibay-insert-reviews-to-productRM_for_ebay', 'theSharkAliExpress_insertReviewsIntoProductRM_for_ebay');
add_action('wp_ajax_sharkDropship-alibay-stop_automatic_update_for_ebay', 'theSharkAliExpress_stopAutomaticUpdates_alibay');
add_action('wp_ajax_sharkDropship-remove-product-from-wp-for-ebay', 'theSharkAliExpress_removeProductFromShop_forEBAY_alibay');
add_action('wp_ajax_sharkDropship-insert-reviews-to-productRM-alibay', 'theSharkAliExpress_insertReviewsIntoProductRM_PREMUIM_PLUGIN_alibay');
add_action('wp_ajax_sharkDropship-restoreConfiguration-alibay', 'theSharkAliExpress_restoreConfiguration_alibay');
add_action('wp_ajax_sharkDropship-wooshark-insert-product-alibay', 'theSharkAliExpress_insertProductInWoocommerce');
add_action('wp_ajax_sharkDropship-get_products-alibay', 'getProduct_FROMWP_alibay');
add_action('wp_ajax_sharkDropship-search-category-by-name-alibay', 'theSharkAliExpress_searchCategoryByName');
add_action('wp_ajax_sharkDropship-get-sku-and-url-by-Category-alibay', 'theSharkAliExpress_getSKuAbdUrlByCategory_alibay');
add_action('wp_ajax_sharkDropship-get-already-imported-products-alibay', 'theSharkAliExpress_getAlreadyImportedProducts');
add_action('wp_ajax_sharkDropship-insert-reviews-to-product-alibay', 'theSharkAliExpress_insertReviewsIntoProduct');
add_action('wp_ajax_sharkDropship-remove-product-from-wp-alibay', 'theSharkAliExpress_removeProductFromShop');
add_action('wp_ajax_sharkDropship-search-product-by-sku-alibay', 'theSharkAliExpress_searchProductBySku');
add_action('wp_ajax_sharkDropship-get_products-draft-alibay', 'theSharkAliExpress_getProductsDraft');
add_action('wp_ajax_sharkDropship-get-old-product-details-alibay', 'theSharkAliExpress_getOldProductDetails');
add_action('wp_ajax_sharkDropship-get-product-by-id-alibay', 'theSharkAliExpress_searchProductByIdReviews_alibay');
add_action('wp_ajax_sharkDropship-saveOptionsDB-alibay', 'theSharkAliExpress_saveOptionsDB_alibay');
add_action('wp_ajax_sharkDropship-getProductsCount-alibay', 'theSharkAliExpress_getProductsCount_FROM_WP');
add_action('wp_ajax_sharkDropship-get_categories-alibay', 'theSharkAliExpress_get_categories_FROMWP');
add_action('wp_ajax_sharkDropship-getProductsCount_for_ebay', 'theSharkAliExpress_getProductsCount_FROM_WP_for_ebay_alibay');
add_action('wp_ajax_sharkDropship-search_product_by_store_alibay', 'theSharkAliExpress_search_product_by_store_alibay');
add_action('wp_ajax_sharkDropship-load_woocommerce_variations_alibay', 'theSharkAliExpress_load_woocommerce_variations_alibay');
add_action('wp_ajax_sharkDropship-get_product_details_alibay', 'theSharkAliExpress_get_product_details_alibay');
add_action('wp_ajax_sharkDropship-get_products_by_type_alibay', 'theSharkAliExpress_get_products_by_type_alibay');
add_action('wp_ajax_sharkDropship-get_aliexpress_products_alibay', 'theSharkAliExpress_get_aliexpress_products_alibay');
add_action('wp_ajax_sharkDropship-update_variations_on_woocommerce_alibay', 'theSharkAliExpress_update_variations_on_woocommerce_alibay');
add_action('wp_ajax_sharkDropship-set_product_to_draft_callback_alibay', 'theSharkAliExpress_set_product_to_draft_callback_alibay');
add_action('wp_ajax_sharkDropship-fetchemote_alibay', 'theSharkAliExpress_fetchemote_alibay');
add_action('wp_ajax_sharkDropship-delete_product_callback_alibay', 'theSharkAliExpress_delete_product_callback_alibay');
add_action('wp_ajax_sharkDropship-updateProductUrlAlibay', 'theSharkAliExpress_updateProductUrlAlibay');
