    ...
    public function settingsPage()
    {
        ...
        ?>
            ...
            <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist" style="padding-top:5px;margin-top:8px; background-color:5px; background-color:#d9d5ce; border-top-left-radius:10px; border-top-right-radius:14px">
                ...
                <li class="nav-item">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#go-other" id="go-other-tab" href="#go-other" role="tab" aria-controls="go-pro" aria-selected="true" style="color:red">Other Plugins </button>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent" style="background-color:#f3f5f6">
                ...
                <div class="tab-pane active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <div class="wrap">
                        <div style="margin-top:10px; background-color:white" class="alert alert-danger alert-dismissible fade show" role="alert" id="section-2">
                            <button class="button-5" style="background-color: green;float: right;padding: 21px;font-size: 19px;color: white;font-family: fantasy;" type="button" class="close">
                                <a style="color:white" target="_blank" href="https://sharkdropship.com/aliexpress"> <small> GO PRO FROM HERE</small> </a>
                            </button>
                            ...
                            <div class="alert alert-default alert-dismissible fade show" role="alert" id="section-1" style="text-align:right; ">
                                ...
                                <strong style="font-size:12px; color: red;">Faster import ? Directly from AliExpress website ? more features and customization ? then install our chrome extension from here <a targer="_blank" href="https://chrome.google.com/webstore/detail/wooshark-for-aliexpress-w/djllcpoailebhlpeligendbbhommfnin" target="_blank"> &nbsp; Link </a></strong> 
                            ...
                            <div style="display:flex; padding:2%;  margin: 1%;border-radius: 10px; background-color:white">
                                ...
                                <div style="flex: 1 1 48%; margin-right:1%">
                                    ...
                                    <div style="display:flex">
                                        ...
                                        <button style="flex: 1 1 35%; margin:0; margin-left:5px; border-radius: 10px;    " class="button-5" id="importProductToShopBySky"> Import </button>
                                    </div>
                                </div>
                                <div style="flex: 1 1 48%; margin-left:1%">
                                    ...
                                    <div style="display:flex">
                                        ...
                                        <button style="flex: 1 1 35%; margin:0; margin-left:5px; border-radius: 10px;    " class="button-5" id="importProductToShopByUrl"> Import </button>
                                    </div>
                                </div>
                            </div>
                            <div class="search-form" style=" padding:2%;  margin: 1%;border-radius: 10px; background-color:white">
                                <h4 style="font-weight:bold">Search by keywords</h4>
                                ...
                                <div style="display:flex">
                                    ...
                                    <button style="border-radius: 10px; flex: 1 1 17%; margin:0; margin-left:5px;     " class="button-5" id="seachProductsButton"> Search Products</button>
                                </div>
                            </div>
                        ...
                        <button id="importAllProductOnThisPage" class="button-5" style="background-color: #9faab4; border-radius: 10px;width:20%; margin-left: 41%; margin-top: 1%"> Import all products on this page <small style="color:red"> (PREMUIM)</small> </button>
                ...
                <div class="tab-pane fade" id="pills-products" role="tabpanel" aria-labelledby="pills-products-products">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button style="  margin-bottom:20px" class="button-5" id="searchBySku">Search by Sku</button>
                        </span>
                    </div>
                    <button style="width:20%; margin-left: 42%; margin-top:20px; margin-bottom:20px" class="button-5 btn-lg disabled" id="updateCurrentPage">Update Stock and price on current page (PREMUIM)</button>
                ...
                <div class="tab-pane fade" id="go-pro" role="tabpanel" aria-labelledby="go-pro-products">
                    <button class="button-5" style="width:20%; margin-left:40%; margin-top:15px; "><a class="" style="color:white" href="https://sharkdropship.com/aliexpress" target="_blank"> GO PRO from here</a> </button>
                    <div>
                        ...
                        <iframe width="30%" style="margin: 20px;" height="315" src="https://www.youtube.com/embed/3hWgT2FDJlw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/3hWgT2FDJlw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                    ...
                    <div style="display:flex">
                        ...
                        <h4 style="    font-family: inherit; text-align:center; flex: 1 1 20%; margin:2%;    border: 1px solid #cbbfbf; padding:2%; border-radius:10px; background-color:white">
                            Import DROPSHIPPING and AFFILIATE products
                        </h4>
                        <h4 style="    font-family: inherit; text-align:center; flex: 1 1 20%; margin:2%;    border: 1px solid #cbbfbf; padding:2%; border-radius:10px; background-color:white">
                ...
                <div class="tab-pane fade" id="go-other" role="tabpanel" aria-labelledby="go-other-products">
                <div style="text-align:center">Amazon dropship & Affiliate By TheShark </div>

                    <button class="button-5" style="width:20%; margin-left:40%; margin-top:15px; "><a class="" style="color:white" href="https://sharkdropship.com/Amazon" target="_blank"> GO PRO for Amazon from here</a> </button>
                    <div>
                        <iframe width="30%" style="margin: 20px;" height="315" src="https://www.youtube.com/embed/ZjAl1V5SWhw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <iframe width="30%" style="margin: 20px;" height="315" src="https://www.youtube.com/embed/1pZ8fH7A8Qw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <iframe width="30%" style="margin: 20px;" height="315" src="https://www.youtube.com/embed/STTozsWbosU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>


<hr>
                            <div style="text-align:center; margin-top:40px">IRIVYOU Import reviews from Amazon and AliExpress </div>


                            <button class="button-5" style="width:20%; margin-left:40%; margin-top:15px; "><a class="" style="color:white" href="https://sharkdropship.com/Amazon" target="_blank"> GO PRO for IRIVYOU from here</a> </button>
                    <div>
                    <!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/m5PK1dR8ufo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->

                        <!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/p_RD4Tq7Sm0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->

                            <!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/rkjnxyrOU4w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                     
                                <iframe width="30%" style="margin: 20px;" height="315" src="https://www.youtube.com/embed/m5PK1dR8ufo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <iframe width="30%" style="margin: 20px;" height="315" src="https://www.youtube.com/embed/p_RD4Tq7Sm0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <iframe width="30%" style="margin: 20px;" height="315" src="https://www.youtube.com/embed/rkjnxyrOU4w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                ...
                <div class="tab-pane fade" id="pills-config" role="tabpanel" aria-labelledby="pills-config-tab" style="background-color:#f3f5f6">
                        ...
                        <div class="switch-text" style="margin:2%; padding:3%; border-radius:10px; background-color:white">
                            <div style=display:flex>
                                ...
                                <div style="flex: 1 1 10%;">
                                    <label style="margin-right:3px">Add Intervall</label><button id="addInterval" class="button-5" style=" margin-dight:5px;color:black"> <i class="fa fa-plus"></i> </button>
                                </div>
                            </div>
                    ...
                    <button id="saveGlobalConfiguration" class="button-5" style="margin-top:20px; width:20%; margin-left:40%"> Save configuration</button>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <button type="button" style="width:25%; margin-top:10px; display:block" class="button-5" id="addReview" style="width:50%;margin-top:10px"> Add Review</button>
                            ...
                            <div class="modal-footer">
                                <button type="button" id="confirmReviewInsertion" class="button-5" data-dismiss="modal">Insert Reviews</button>

                                <button type="button" class="button-5" data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
